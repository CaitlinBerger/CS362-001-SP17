...
public class ApptRandomTest {
	...
	//			System.out.println(" Seed:"+randomseed );
				...
				//generate random values for each init values checked by the "isValid" function
				 int startHour=ValuesGenerator.getRandomIntBetween(random, -24, 48);
				 ...
				 int startMonth=ValuesGenerator.getRandomIntBetween(random, -12, 24);
				 int startYear=2017;
				...
				for (int i = 0; i < NUM_TESTS; i++) {
					...
					if (methodName.equals("setTitle")){
						...
						//code to randomly test the setDescription function
